 ...
 *
 */
$drupal_hash_salt = 'b3e4cab1177060a178448a196f986a869632848d215bcf6f0ea9b1941f64';
 ...
 */
ini_set('session.cookie_lifetime', 0); // 0 per request by Depth Security
...
# Override to HIDE in production, but DISPLAY_ALL for dev & staging
# $conf['error_level'] = 0; // 0 = ERROR_REPORTING_HIDE
# $conf['error_level'] = 2; // 2 = ERROR_REPORTING_DISPLAY_ALL

ini_set('memory_limit', '256M');

// # Memcache defaults - override $conf['memcache_servers'] for multi-server config
/*
$conf['cache_backends'][] = 'sites/all/modules/contrib/memcache/memcache.inc';
$conf['cache_default_class'] = 'MemCacheDrupal';
$conf['cache_class_cache_form'] = 'DrupalDatabaseCache';
$conf['memcache_key_prefix'] = 'unfisp';

// Set default environment to local so you don't need to worry about this in local_settings.php
