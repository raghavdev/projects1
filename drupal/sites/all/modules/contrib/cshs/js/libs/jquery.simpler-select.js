  ...
  Plugin.prototype = {
    init: function () {
      ...
      $.each(initialParents, function (idx, value) {
        ...
        var $nextSelect = that.createSelect(that._selectOptions[value].children, value, idx+1);
    ...
    onChange: function ($currentSelect) {
      ...
      if (typeof this._selectOptions[selectedValue].children !== 'undefined') {
        var currentLevel = this.selectGetLevel($currentSelect);
        $newSelect = this.createSelect(this._selectOptions[selectedValue].children, selectedValue, currentLevel);
